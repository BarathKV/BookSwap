    ...
    <div className="bg-[#eaecff] min-h-screen">
            ...
            <div className="lg:w-1/2">
              <div className="bg-white rounded-xl p-4 sm:p-8 h-full min-h-[300px] sm:min-h-[400px] lg:min-h-[600px] shadow-[1px_4px_4px_0_rgba(0,0,0,0.25)] sm:shadow-[1px_10px_4px_0_rgba(0,0,0,0.36)]">
                ...
                <div className="pt-3 sm:pt-4 text-xs sm:text-sm md:text-base overflow-y-auto max-h-[150px] sm:max-h-[250px]">
                  ...
                  Sequi, nam dicta corrupti neque quisquam, aspernatur nesciunt
                  accusantium sed, magni amet excepturi voluptatum hic cum fuga
                  nulla sapiente laboriosam incidunt consectetur? Quis assumenda
                  corrupti magni minus vitae esse dolorem rem. Est nisi soluta
                  nobis velit totam deserunt nihil consectetur facere adipisci
                  voluptatibus, earum alias nesciunt aut debitis placeat
                  incidunt maxime voluptate minus corporis laborum expedita nam.
                  Dolores culpa eum, blanditiis eius, consequuntur natus
                  expedita cupiditate dolore fuga assumenda iusto quibusdam
                  voluptatem libero sapiente officia, commodi neque doloribus.
                  Totam, sed ratione doloribus impedit tempore maxime? Minima
                  voluptas, cumque temporibus minus eligendi voluptatibus.
                </div>
      ...
      <div className=" wrapper py-4 my-4 flex justify-center">
        <div className="flex gap-4 sm:gap-8 w-full max-w-md px-4">
          ...
          <Link
            to="/wishlist"
            className="bg-white h-10 w-full rounded-full text-[#000959] text-sm sm:text-base shadow-[1px_4px_4px_0_rgba(0,0,0,0.25)] transform transition duration-300 hover:scale-105 flex justify-center items-center">
            <div>Wishlist it</div>
          </Link>
        </div>
      </div>
